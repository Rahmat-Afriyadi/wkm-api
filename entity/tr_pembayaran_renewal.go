...
type TrPembayaranRenewal struct {
	...
	CetakKe             uint64    `form:"cetak_ke" json:"cetak_ke" gorm:"column:cetak_ke"`
	...
	TglUpdate           time.Time `form:"tgl_update" json:"tgl_update" gorm:"type:DATE;default:null;column:tgl_update"`
}
